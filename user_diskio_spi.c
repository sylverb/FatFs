...
#define FCLK_SLOW() { HAL_SPI_DeInit(&SD_SPI_HANDLE); \
                      SD_SPI_HANDLE.Init.BaudRatePrescaler = SPI_BAUDRATEPRESCALER_128; \
                      HAL_SPI_Init(&SD_SPI_HANDLE);} /* Set SCLK = slow */
#define FCLK_FAST() { HAL_SPI_DeInit(&SD_SPI_HANDLE); \
                      SD_SPI_HANDLE.Init.BaudRatePrescaler = SPI_BAUDRATEPRESCALER_2; \
                      HAL_SPI_Init(&SD_SPI_HANDLE);} /* Set SCLK = fast */
